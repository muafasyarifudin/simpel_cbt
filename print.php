<?php
require __DIR__ . '/view/private/page/page.cbt.print.php';
exit;
/**
 * simpel_cbt - Cetak Sertifikat & Transkrip Hasil Ujian CBT (Modern Minimalist Hybrid)
 */
require_once __DIR__ . '/config/database.php';
require_once __DIR__ . '/helpers/cbt_helper.php';
...
$hashVerify = strtoupper(substr(md5($d['id_sesi'] . $d['no_pendaftaran'] . 'SIMPEL_CBT_SECRET_2026'), 0, 12));

// QR Verification URL
$verifyUrl = BASE_URL . "print.php?id_sesi=" . $d['id_sesi'] . "&verify=1";
